...
<ol>
<li>
Obtain the <a href="http://code.google.com/p/plume-lib/">source code</a>:
<pre>hg clone https://code.google.com/p/plume-lib/</pre>
</li>
<li>
Build plume-lib:
<pre>cd plume-lib
...
add the <tt>emacs</tt> subdirectory to Emacs's <tt>load-path</tt>.
</li>
</ol>
<p>
(As an alternative to steps 1 and 2 above, you can download file
<a href="http://code.google.com/p/plume-lib/downloads/list">plume-lib-<em>X.Y.Z</em>.tar.gz</a>
from Google Code.)
</p>
...
are governed by a different license.  See file <a href="http://plume-lib.googlecode.com/hg/LICENSE.txt">LICENSE.txt</a> for details.
</p>
...
<dt>checklink</dt>
<dd>
  A slightly <a href="bin/checklink-4.6.diff">modified</a> version of the
...
<dt>transgif</dt>
<dd>
  Change a <tt>.gif</tt> file's background to transparent.
...
<dt>add-favicon</dt>
<dd>
  Takes as arguments a directory and a <tt>.png</tt> file for a "favicon".
  It makes each HTML file under the given directory use the given favicon.  A
  favicon is a favorites icon, which is intended to appear in the address
  bar of your browser when you browse to the given page.
  <a href="http://plume-lib.googlecode.com/hg/bin/add-favicon">Documentation</a> at top of file.
</dd>
</dl>
...
<dd>
Reads standard output, and if not empty calls the <tt>mail</tt> program.
This feature is useful in scripts and cron jobs, but is not supported
in all versions of <tt>mail</tt>.
<a href="http://plume-lib.googlecode.com/hg/bin/mail-e">Documentation</a>
at top of file.
</dd>
...
<dd>
  ...
  <a href="http://plume-lib.googlecode.com/hg/bin/imap-move">Documentation</a> at top of file.
</dd>
</dl>
...
<a href="http://plume-lib.googlecode.com/hg/bin/path-remove">Documentation</a> at top of file.
</dd>
...
<a href="http://plume-lib.googlecode.com/hg/bin/cronic">at top of file</a> and at
<a href="http://habilis.net/cronic/">http://habilis.net/cronic/</a>.
</dd>
...
<a href="http://plume-lib.googlecode.com/hg/bin/junk.doc">Documentation</a> in
file junk.doc.
</dd>
...
<a href="http://plume-lib.googlecode.com/hg/bin/sort-directory-order">Documentation</a>
at top of file.
</dd>
...
<dd>
Like <tt>sort</tt>, but the key is the reverse of each line.
Some <tt>sort</tt> implementations have a flag <tt>-r</tt> that has this
same effect.
</dd>
...
<dt>javadoc-cygwin</dt>
<dd>
  A wrapper for calling Javadoc from Cygwin, that tries to convert any
  arguments that are Unix-style paths into Windows-style paths.
  <a href="http://plume-lib.googlecode.com/hg/bin/javadoc-cygwin">Documentation</a> at top of file.
</dd>
</dl>
...
<dd>
  ...
  <ul>
    ...
    <li>creates documentation suitable for a manual, webpage, or manpage.</li>
  </ul>
  ...
  <!-- The popular JCommander library was written later and takes a similar approach to plume-lib, having many of the same features.  But it does not generate usage messages nor manual/manpage/webpage documentation. -->
</dd>
</dl>
...
<dd>
  ...
  <a href="http://types.cs.washington.edu/plume-lib/api/plume/RegexUtil.html">Documentation</a>.
</dd>
...
<!--  LocalWords:  mvc MultiVersionControl cvschanges cvs cvsdiff diff diffs pl PostScript Cygwin
 -->
...
<!--  LocalWords:  uwisdom preplace timestamp ICalAvailable iCalendar regexps
 -->
<!--  LocalWords:  regexp notbetween upto striplines checkargs hg cd emacs
 -->
<!--  LocalWords:  gz txt html webpage's checklink args HtmlPrettyPrint
 -->
<!--  LocalWords:  filepp urls bibtex transgif java CLASSPATH
 -->
